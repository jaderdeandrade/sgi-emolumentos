object fmCaixa: TfmCaixa
  ...
  object RLReport1: TRLReport
    ...
    object RLBand1: TRLBand
      ...
      object RLLabelUsuario: TRLLabel
        Left = 496
        Top = 64
        Width = 120
        Height = 16
    ...
    object RLBand3: TRLBand
      ...
      object RLLabelCredito: TRLLabel
        Left = 72
        Top = 8
        Width = 120
        Height = 16
      end
      object RLLabelDebito: TRLLabel
        Left = 360
        Top = 8
        Width = 112
        Height = 16
      end
      object RLLabelSaldo: TRLLabel
        Left = 608
        Top = 8
        Width = 104
        Height = 16
  ...
  object RxDBLookupComboUsuario: TRxDBLookupCombo
    Left = 408
    Top = 24
    Width = 185
    Height = 21
    ...
    DisplayEmpty = '[TODOS]'
    EmptyValue = '[TODOS]'
    LookupField = 'USU_LOGIN'
    LookupDisplay = 'USU_LOGIN'
  ...
  object sdsUsuarios: TSQLDataSet
    CommandText = 'select * from USUARIOS order by USUARIOS .USU_LOGIN'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = dmconect.SQLConnection1
    Left = 743
