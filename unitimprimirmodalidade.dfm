object fmImprimirModalidade: TfmImprimirModalidade
  Left = 402
  Top = 257
  ...
  object sqlModalidade: TSQLDataSet
    CommandText = 
      ...
      'ail, modalidade.descricao, modalidade.cliente_idcliente'#13#10'from mo' +
      'dalidade'#13#10'   inner join cliente on (modalidade.cliente_idcliente' +
      ' = cliente.idcliente)'#13#10'   inner join servico on (modalidade.desc' +
      'ricao = servico.descricao)'
    MaxBlobSize = -1
    Params = <>
