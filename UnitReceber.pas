...
begin
  ...
  if (b <= 0) then
    begin
      showmessage('ATENÇÃO! O valor a receber não poder menor que ZERO.');
      ceReceber.Text:= ceDebito.Text;
      ceSaldo.Text:= '';
  end;
  //valor a receber não pode ser menor ou igual a zero
...
begin
  if RxDBLookupCombo1.Text <> '' then
    ...
    if RxDBLookupCombo1.Text = '' then
      begin
        ShowMessage('Atenção! Plano de Contas é obrigatório.');
      end;
end;
