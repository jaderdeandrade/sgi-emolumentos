object fmManutencaoContasReceber: TfmManutencaoContasReceber
  Left = 200
  Top = 126
  BorderStyle = bsSingle
  Caption = 'Manuten'#231#227'o do Contas a Receber'
  ClientHeight = 466
  ClientWidth = 896
  Color = clBtnFace
  ...
  object sqlreceber: TSQLDataSet
    CommandText = 
      'select * from CONTASRECEBER where (CONTASRECEBER .ATIVO='#39'1'#39') and' +
      #13#10'(CONTASRECEBER.CLIENTE_IDCLIENTE=:empresa )'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object dspreceber: TDataSetProvider
    DataSet = sqlreceber
    Options = [poIncFieldProps, poAllowCommandText]
    OnGetTableName = dspreceberGetTableName
    Left = 16
    Top = 200
  end
  ...
  object spreceber: TSQLStoredProc
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
        Name = 'IDCONTASRECEBER'
        ParamType = ptInput
      end>
    SQLConnection = dmconect.SQLConnection1
    StoredProcName = 'DELETACONTASRECEBER'
    Left = 24
    Top = 280
  end
end
